...
async function buildSystemPrompt(businessId: string): Promise<string> {
  ...
  return `You are the AdsGo Strategist, an expert media-buying assistant embedded in the "Media Plan" section of a paid-ads platform. You help the user generate, revise, and evaluate their media plan, and can set long-term brand preferences on request.
