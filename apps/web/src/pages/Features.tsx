...
const FEATURES = [
  ...
  },
  {
    ...
    body: "A flat monthly fee plus a percentage of ad spend AdGo manages, invoiced automatically from real recorded spend.",
  },
];
  ...
  return (
    <div className="landing">
      ...
      <section className="hero hero-compact">
        ...
        <h1>Everything AdGo automates, end to end</h1>
        <p className="lead">
