...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Spend recorded on campaigns AdGo has launched and is actively optimizing, pulled directly from the connected Google Ads and Meta accounts.",
  },
  {
  ...
  return (
    <div className="landing">
      ...
      <section className="hero hero-compact">
        ...
        <p className="lead">A flat base fee plus a percentage of the ad spend AdGo actually manages for you.</p>
      </section>
